...
class App extends Component {
  ...
  onClickChangeImage = thumbnailUrl => {
  ...
  render() {
    const {isTrue, activeTabId, activeimage, score, time} = this.state

    const resultActiveCategory = imagesList.filter(
      each => each.category === activeTabId,
    )

    /* console.log(resultActiveCategory) */
          ...
          {!isTrue && (
            <div className="first-div">
              ...
              <ul className="thumbnail-images-list-container">
                {resultActiveCategory.map(eachImg => (
                  <li className="thumbnail-image-list-item" key={eachImg.id}>
                    <button
                      type="button"
                      className="thumbnail-button-image"
                      onClick={() =>
                        this.onClickChangeImage(eachImg.thumbnailUrl)
                      }
                    >
                      <img
